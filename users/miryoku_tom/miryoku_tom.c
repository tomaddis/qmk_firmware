...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_miryoku(
    ...
    LGUI_T(KC_A),      LALT_T(KC_R),      LSFT_T(KC_S),      LCTL_T(KC_T),      KC_G,              KC_K,              LCTL_T(KC_N),      LSFT_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),
    KC_Z,              ALGR_T(KC_X),      KC_C,              KC_D,              KC_V,              KC_M,              KC_H,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,
    U_NP,              U_NP,              LT(FUN, KC_DEL),   LT(NUM, KC_BSPC),  LT(SYM, KC_ENT),   LT(MOUSE, KC_TAB), LT(NAV, KC_SPC),   LT(MEDIA, KC_ESC), U_NP,              U_NP
  #elif defined MIRYOKU_ALPHAS_DVORAK
    KC_QUOT,           KC_COMM,           KC_DOT,            KC_P,              KC_Y,              KC_F,              KC_G,              KC_C,              KC_R,              KC_L,
    LGUI_T(KC_A),      LALT_T(KC_O),      LSFT_T(KC_E),      LCTL_T(KC_U),      KC_I,              KC_D,              LCTL_T(KC_H),      LSFT_T(KC_T),      LALT_T(KC_N),      LGUI_T(KC_S),
    ...
    LGUI_T(KC_S),      LALT_T(KC_H),      LSFT_T(KC_N),      LCTL_T(KC_T),      KC_COMM,           KC_DOT,            LCTL_T(KC_A),      LSFT_T(KC_E),      LALT_T(KC_O),      LGUI_T(KC_I),
    ...
    LGUI_T(KC_A),      LALT_T(KC_S),      LSFT_T(KC_H),      LCTL_T(KC_T),      KC_G,              KC_Y,              LCTL_T(KC_N),      LSFT_T(KC_E),      LALT_T(KC_O),      LGUI_T(KC_I),
  ...
  [NAV] = LAYOUT_miryoku(
    ...
    KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_CAPS, U_NA,    KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
  ...
  [MOUSE] = LAYOUT_miryoku(
    ...
    KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, U_NU,    U_NA,    KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
    U_UND,   U_CUT,   U_CPY,   U_PST,   U_RDO,   U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
  ...
  [MEDIA] = LAYOUT_miryoku(
    ...
    U_NU,    KC_MPRV, KC_VOLD, KC_MNXT, U_NU,    U_NA,    KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
  ...
  [NAV] = LAYOUT_miryoku(
    ...
    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_CAPS, U_NA,    KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
    U_UND,   U_CUT,   U_CPY,   U_PST,   U_RDO,   U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
    U_NP,    U_NP,    KC_DEL,  KC_BSPC, KC_ENT,  U_NA,    U_NA,    U_NA,    U_NP,    U_NP
  ),
  [MOUSE] = LAYOUT_miryoku(
  ...
  [NUM] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, U_NA,    KC_EQL,  KC_4,    KC_5,    KC_6,    KC_SCLN,
  ...
  [SYM] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, U_NA,    KC_PLUS, KC_DLR,  KC_PERC, KC_CIRC, KC_COLN,
  ...
  [FUN] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, U_NA,    KC_SLCK, KC_F4,   KC_F5,   KC_F6,   KC_F11,
...
,
  ...
  [NUM] = LAYOUT_miryoku(
    KC_LBRC, KC_7,    KC_8,    KC_9,    KC_RBRC, U_NA,    U_NA,    U_NA,    U_NA,    TG(SUDOKU),
  ...
  [FUN] = LAYOUT_miryoku(
    ...
    KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SLCK, U_NA,    KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
    KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS, U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
    U_NP,    U_NP,    KC_APP,  KC_SPC,  KC_TAB,  U_NA,    U_NA,    U_NA,    U_NP,    U_NP
  ),
  [SUDOKU] = LAYOUT_miryoku(
    KC_DEL,  KC_7,    KC_8,    KC_9,    C(KC_A), U_NA,    U_NA,    U_NA,    U_NA,    TG(SUDOKU),
    U_UND,   KC_4,    KC_5,    KC_6,    U_NA,    U_NA,    KC_LCTL, KC_LSFT, U_NA,    U_NA,
    U_RDO,   KC_1,    KC_2,    KC_3,    U_NA,    U_NA,    U_NA,    U_NA,    U_NA,    U_NA,
    U_NP,    U_NP,    KC_0,    KC_LCTL, KC_LSFT, U_NA,    U_NA,    U_NA,    U_NP,    U_NP
  )
#endif
};
